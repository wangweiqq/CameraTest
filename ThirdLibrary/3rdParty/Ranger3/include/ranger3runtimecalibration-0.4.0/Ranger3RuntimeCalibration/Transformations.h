...
//AVX versions of v2 application only.
	...
	inline Point2D sensorToWorld(const Point2D& sp, const double* const lens, const double& sch_roll, const double& sch_tilt, const double* const H);
	...
	void sensorToWorld(const std::vector<Point2D>& sp, std::vector<Point2D>& wp, const double* const lensSensorToWorld, const double& sch_roll, const double& sch_tilt, const double* const H);
